...
OUTDIR_HOME=/projects/science/output/merged/usermodel-camp-T1-T2/${T1_end}
...
echo $hstream -D mapred.reduce.tasks=100 -D mapred.job.name=T1-T2-camp-usermodel-merge -input $input_camp_t1,$input_camp_t2,${input_user_model},/projects/science/output/intent/query/${T1_end},/projects/science/input/user_model/rtb/${T1_end} -output ${OUTDIR_HOME} -mapper "cat" -reducer "$pythonbin red_merge_usermodel_camp.py" -file "$PYDIR/red_merge_usermodel_camp.py"
$hstream -D mapred.reduce.tasks=100 -D mapred.job.name=T1-T2-camp-usermodel-merge -input $input_camp_t1,$input_camp_t2,${input_user_model},/projects/science/output/intent/query/${T1_end},/projects/science/in\
put/user_model/rtb/${T1_end} -output ${OUTDIR_HOME} -mapper "cat" -reducer "$pythonbin red_merge_usermodel_camp.py" -file "$PYDIR/red_merge_usermodel_camp.py"
