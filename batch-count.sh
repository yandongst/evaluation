...
OUTDIR_HOME=/projects/output/merged/usermodel-camp-T1-${T1_start}-${T1_end}-T2-${T2_start}-${T2_end}-count

if [ $tagseg == 1 ]
then
  INPUT_HOME=/projects/output/merged/usermodel-camp-T1-${T1_start}-${T1_end}-T2-${T2_start}-${T2_end}-tagseg
  OUTDIR_HOME=/projects/output/merged/usermodel-camp-T1-${T1_start}-${T1_end}-T2-${T2_start}-${T2_end}-tagseg-count
fi
